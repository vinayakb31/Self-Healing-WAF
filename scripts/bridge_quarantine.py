...
def classify_with_guardrails(payload):
    """Never allow the LLM to mark obvious attack signatures as normal."""
...
def run_bridge():
    ...
    for req_id, payload in pending_requests:
        ...
        attack_type, source = classify_with_guardrails(payload)
        ...
        if attack_type.lower() == "normal":
            ...
            print("  Diagnosis: Unknown. Marking REVIEW_REQUIRED for human review.")
